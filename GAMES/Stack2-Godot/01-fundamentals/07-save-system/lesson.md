...
## Learning Outcomes
- Explain and implement persisting settings and high score safely in a mobile 2D context.
...
## Deep Dive
### Concept Model
persisting settings and high score safely drives responsiveness and fairness in short-session mobile games.
