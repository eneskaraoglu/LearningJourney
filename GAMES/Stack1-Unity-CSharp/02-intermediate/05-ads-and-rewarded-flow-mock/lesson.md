...
- Level: Intermediate+
- Duration: 80 min
- Prerequisites: Intermediate 04

## Learning Outcomes
- Explain the core tradeoffs behind rewarded flow mock.
...
Implement an adapter-based rewarded flow mock while keeping gameplay logic ad-SDK independent.
