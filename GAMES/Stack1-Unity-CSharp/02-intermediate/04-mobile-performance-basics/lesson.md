...
- Level: Intermediate+
- Duration: 120 min
- Prerequisites: Intermediate 03

## Learning Outcomes
- Explain the core tradeoffs behind mobile performance basics.
...
Profile CPU, GPU, and memory, then apply practical fixes for stable frame times.
