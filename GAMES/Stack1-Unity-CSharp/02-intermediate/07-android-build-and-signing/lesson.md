...
- Level: Intermediate+
- Duration: 110 min
- Prerequisites: Intermediate 06

## Learning Outcomes
- Explain the core tradeoffs behind android build and signing.
...
Configure Android player settings, keystore signing, and internal testing build outputs.
