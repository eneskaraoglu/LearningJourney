...
- Level: Intermediate+
- Duration: 90 min
- Prerequisites: Intermediate 07

## Learning Outcomes
- Explain the core tradeoffs behind polish and juice.
...
Add screen shake, hit pause, particles, and micro-feedback while preserving readability.
