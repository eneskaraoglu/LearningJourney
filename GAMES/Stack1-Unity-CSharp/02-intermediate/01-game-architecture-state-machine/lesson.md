# Game Architecture and State Machine

## Module Info
- Level: Intermediate+
- Duration: 120 min
- Prerequisites: All Fundamentals

## Learning Outcomes
- Explain the core tradeoffs behind game architecture and state machine.
...
Separate gameplay flow into explicit states to reduce bugs and simplify feature additions.
