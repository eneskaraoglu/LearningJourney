...
## Learning Outcomes
- Explain the core tradeoffs behind 2d physics and collisions.
...
Build predictable physics behavior using Rigidbody2D, colliders, layers, and trigger/event callbacks.
