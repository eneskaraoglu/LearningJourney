# Async Loading and Addressables Intro

## Module Info
- Level: Advanced
- Duration: 120 min
- Prerequisites: Advanced 02

## Learning Outcomes
- Explain the core tradeoffs behind async loading and addressables ýntro.
...
Load assets/scenes asynchronously to hide latency and prevent frozen frames.
