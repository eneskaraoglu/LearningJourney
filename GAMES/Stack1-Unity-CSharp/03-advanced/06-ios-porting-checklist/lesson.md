...
- Level: Advanced
- Duration: 90 min
- Prerequisites: Advanced 05

## Learning Outcomes
- Explain the core tradeoffs behind ios porting checklist.
...
Prepare resolution, input, permissions, and store metadata differences for iOS release.
